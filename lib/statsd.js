 ...
 *   @option log       {Function} An log function to be used for debugging.
 * @constructor
 */
var Client = function (host, port, prefix, suffix, cacheDns, mock, log) {
  var options = host || {},
         self = this;
  ...
  if (typeof options.prefix === 'string' && options.prefix !== '') {
    // Make trailing dot optional for the prefix.
...
Client.prototype.herokuLog = function () {
  var that = this;
  return function herokuLog(req, res, next) {
